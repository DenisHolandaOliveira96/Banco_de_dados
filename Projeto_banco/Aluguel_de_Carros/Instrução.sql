...
SELECT 
	...
	FROM 
		tb_aluguel
	INNER JOIN 
		tb_cliente ON tb_aluguel.cliente_id = tb_cliente.cliente_id
	INNER JOIN 
		tb_veiculo ON tb_cliente.cliente_id = tb_veiculo.veiculo_id;
        
        
--CONSULTA INNER JOIN COM CLAUSULA - 'DISPONIVEL'
...
SELECT 
	...
	INNER JOIN 
		...
		SELECT veiculo_id, modelo, ano, placa, disponibilidade FROM tb_veiculo WHERE disponibilidade = 'Disponivel';
        
        
--CONSULTA INNER JOIN COM CLAUSULA 'ALUGADO'
...
SELECT 
	...
	INNER JOIN 
		...
		SELECT veiculo_id, modelo, ano, placa, disponibilidade FROM tb_veiculo WHERE disponibilidade = 'Alugado';
  -------------------------------------------------------------------------------------------------------------------------------

--MUDAR INFORMAÇÕES tb_cliente--
----------------------------------------------------------------------------------------------------------------------------------
	UPDATE tb_cliente
	SET nome = 'Estella'
	WHERE cliente_id = 1;
...
--DELETAR INFORMAÇÕES NA tb_aluguel--
